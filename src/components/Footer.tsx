...
export function Footer(){
  ...
  return <footer className="footer"><div className="footer-big">DROP / 001</div><div className="footer-grid">
    <div><span>TIENDA</span><Link to="/shop">Todos los productos</Link><Link to="/shop?cat=Jeans">Denim</Link></div>
    ...
    <div><span>COMPRA</span><button onClick={()=>ui.openInfo('advice')}>Asesoría</button><button onClick={()=>ui.openInfo('shipping')}>Envíos</button></div>
