...
export const seedProducts:Product[]=[
  ...
  {id:'tee-01',slug:'ref-temporal-tee-01',name:'Camiseta Gráfica',nameStatus:'provisional',subtitle:'Gráfica · Oversized',description:'Camiseta gráfica de fit oversized.',categoryId:'cat-streetwear',category:'Streetwear',fit:'Oversized',color:'Multi',price:null,compareAtPrice:null,featured:true,bestSeller:true,newArrival:false,status:'active',sortOrder:3,shopifyProductId:null,shopifyHandle:null,features:[],variants:variants('tee-01',['S','M','L','XL']),media:media('tee-01',driveImage(ids.tee1),'Camisetas gráficas reales del cliente'),collections:[drop,collections[2]]},
  {id:'set-01',slug:'ref-temporal-set-01',name:'Conjunto Negro',nameStatus:'provisional',subtitle:'Negro · Regular',description:'Conjunto negro de fit regular.',categoryId:'cat-sets',category:'Conjuntos',fit:'Regular',color:'Black',price:null,compareAtPrice:null,featured:true,bestSeller:false,newArrival:true,status:'active',sortOrder:4,shopifyProductId:null,shopifyHandle:null,features:[],variants:variants('set-01',['S','M','L','XL']),media:media('set-01',driveImage(ids.setBlack),'Conjunto negro real del cliente'),collections:[drop]},
