...
export function AdminHomePage(){
  ...
  async function save(){if(!home)return;setBusy(true);setMessage(null);try{await saveHomepage(home);setMessage('Home guardada.')}catch(e){setMessage(e instanceof Error?e.message:'Error guardando Home')}finally{setBusy(false)}}
